...
You can also set a different date format for specific locales, for example:
...
SMTP connection type, used with "mail.smtp.host":#mail.smtp.host. Values:
